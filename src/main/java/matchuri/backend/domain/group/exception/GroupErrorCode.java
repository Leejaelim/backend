...
public enum GroupErrorCode implements ErrorCode {
    ...
    INVITE_LINK_ALREADY_EXISTS(HttpStatus.CONFLICT, "아직 만료되지 않은 그룹 초대 링크가 있습니다. groupId : {0}"),
    INVITE_LINK_NOT_FOUND(HttpStatus.NOT_FOUND, "유효한 그룹 초대 링크를 찾을 수 없습니다."),
    INVITE_LINK_EXPIRED(HttpStatus.CONFLICT, "만료된 그룹 초대 링크입니다."),
    INVITE_LINK_TOKEN_GENERATION_FAILED(HttpStatus.CONFLICT, "그룹 초대 링크 토큰 생성에 실패했습니다."),
