...
class GroupRecommendationExpirationServiceTest {

    private static final LocalDateTime NOW = LocalDateTime.of(2026, 8, 31, 12, 0);
    private final GroupRecommendationExpirationService service = new GroupRecommendationExpirationService();
    ...
    void preparingHasNoVotingStartedAt() {
        ...
        assertThat(service.isExpired(recommendation, NOW)).isFalse();
    }
    ...
    void expirationUsesCreatedAtEvenWhenVotingStartedRecently() {
        ...
        assertThat(service.isExpired(recommendation, NOW)).isTrue();
    }
